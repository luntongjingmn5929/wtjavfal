package com.bayside.app.opinion.mobile.war.knowledge.service.impl;
...
import com.bayside.app.opinion.mobile.war.knowledge.controller.KnowledgeController;
import com.bayside.app.opinion.mobile.war.knowledge.dao.RelevantMapper;
...
//	private static Logger Log = LoggerFactory.getLogger(KnowledgeServiceImpl.class);
	@Autowired
	private RelevantMapper relevantMapper;
	@Autowired
	private MessagecenterMapper messagecenterMapper;
	private static final Logger log = Logger.getLogger(KnowledgeServiceImpl.class);
	@Override
	...
	public SolrDocumentList getQueryCondition(RelevantBo relevantBo,SolrPage page,String solrUrl,String query){
		...
		if(containanyone!=null&&!"".equals(containanyone)&&containanyone!="null"&&!containanyone.equals("null")){
		...
		titleq.append(")");
		contentq.append(")");
		if(containall!=null&&!"".equals(containall)&&containall!="null"&&!containall.equals("null")){
			titleq.append(" AND (");
			contentq.append(" AND (");
		...
		if(notcontainall!=null&&!"".equals(notcontainall)&&notcontainall!="null"&&!notcontainall.equals("null")){
		...
		if(notcontainanyone!=null&&!"".equals(notcontainanyone)&&notcontainanyone!="null"&&!notcontainanyone.equals("null")){
		...
		String shards = AppConstant.solrUrl.WEIBOPAGE+","
		 ...
		 ModifiableSolrParams solrParams = new ModifiableSolrParams();  
	        ...
	        /*if(AppConstant.mediaType.PRINT_MEDIA.equals(relevantBo.getMediaType())||AppConstant.mediaType.APP.equals(relevantBo.getMediaType())){
	        	//solrParams.set("sort",SolrQuery.ORDER.desc);
	        	solrParams.set("sort","updateTime desc");
			}else{*/
